<template>
    <div class="report_page">
        ...
        <div class="report_body">
            <div class="report_item" v-for="item in reportCityData" :key="index">
                <img :src=item.img style="width: 50%;height: 100%;right: 3%">
                <div style="top: 5%;display: flex;flex-direction: column;">
...
<script>
  ...
  export default {
    ...
    setup(){
      ...
      let reportCityData = JSON.parse(JSON.stringify(areaDataStore.reportCityData));
      reportCityData.forEach((item)=>{
